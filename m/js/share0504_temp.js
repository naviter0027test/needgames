...
(function($){
  ...
  popbaseuseru2 = function(y) { //title/內容/是否可以關閉
   ...
   nl2br=function(x){
	 //   if(x.indexOf("newsfilebox")>0){//有圖
            ...
            xplus+=ytphrase(yy,vidcnt,"margin:0;max-width:100%;");
						vidcnt++;
   ...
   insert_changerchat=function(x){
    ...
    //  if(isios==1){
    //    newx="<div class='box photo'><object width='100%' height='150' ><param name='movie' value='https://www.youtube.com/v/"+yy+"&hl=en_US&feature=player_embedded&version=3'></param><param name='allowFullScreen' value='true'></param><param name='allowScriptAccess' value='always'></param><embed src='https://www.youtube.com/v/"+yy+"?suggestedQuality=medium&hl=en_US&feature=player_embedded&version=3' type='application/x-shockwave-flash' allowfullscreen='true' allowScriptAccess='always'></embed></object><span class=time>"+mtime+"</span></div>";
    //  }else{
	 ...
	 //   if(x.indexOf("newsfilebox")>0){//有圖
			...
			if(xa){
				...
				for(var a=0;a<xx.length;a++){
					...
					if(xx[a].indexOf("https://www.youtube.com/watch?v&#061;")==0){
						var yy=xx[a].split("https://www.youtube.com/watch?v&#061;")[1];
            xx2+=ytphrase(yy,0,"margin:0;max-width:100%;");
					}else if(xx[a].indexOf("https://m.youtube.com/watch?v&#061;")==0){
						var yy=xx[a].split("https://m.youtube.com/watch?v&#061;")[1];
            xx2+=ytphrase(yy,0,"margin:0;max-width:100%;");
					}else if(xx[a].indexOf("https://youtu.be/")==0){
   ...
   nl2brx=function(x){
		...
		if(xa){
			...
			for(var a=0;a<xx.length;a++){
				...
				if(xx[a].indexOf("https://www.youtube.com/watch?v&#061;")==0){
					var yy=xx[a].split("https://www.youtube.com/watch?v&#061;")[1];
          xx2+=ytphrase(yy,0,"margin:0 -10px;");
				}else if(xx[a].indexOf("https://m.youtube.com/watch?v&#061;")==0){
					var yy=xx[a].split("https://m.youtube.com/watch?v&#061;")[1];
          xx2+=ytphrase(yy,0,"margin:0 -10px;");
				}else if(xx[a].indexOf("https://youtu.be/")==0){
  ...
  ytphrase=function(x,y,st){//生成youtube插件-- x=yy  y== vidcnt
    var ot="";
  //  if(isios==1){
  //    ot="<iframe class='vitem' width='468' height='263' style='"+((y>0)?"display:none;":"")+" "+st+"' src='https://www.youtube.com/embed/"+x+"' frameborder='0'  webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>";
//      ot="<object class='vitem' width='468' height='263' style='"+((y>0)?"display:none;":"")+" "+st+"'><param name='movie' value='https://www.youtube.com/v/"+x+"&hl=en_US&feature=player_embedded&version=3'></param><param name='allowFullScreen' value='true'></param><param name='allowScriptAccess' value='always'></param><embed src='https://www.youtube.com/v/"+x+"?suggestedQuality=medium&hl=en_US&feature=player_embedded&version=3' type='application/x-shockwave-flash' allowfullscreen='true' allowScriptAccess='always'></embed></object>";
    //}else{
      ot="<iframe class='vitem' width='468' height='263' style='"+((y>0)?"display:none;":"")+" "+st+"' src='https://www.youtube.com/embed/"+x+"' frameborder='0'  webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>";
  //  }
    return ot;
	...
	$("body").delegate('#newstext','keyup', function(){
		if($("#newsformfilebox").html()){//已有資料
			...
			for(var a=0;a<xx.length;a++){
				if(xx[a].indexOf("https://www.youtube.com/watch?v=")==0){
					var yy=xx[a].split("https://www.youtube.com/watch?v=")[1];
          tmp=ytphrase(yy,0,"margin:0 -10px;");
					$("#newsformfilebox").html(tmp);
					break;
				}else if(xx[a].indexOf("https://m.youtube.com/watch?v=")==0){
					var yy=xx[a].split("https://m.youtube.com/watch?v=")[1];
          tmp=ytphrase(yy,0,"margin:0 -10px;");
