...
show_register=function(x=0){ //20190509 Pman x=0:一般流程 x=1:FB註冊流程
	...
	out+="                    我已詳閱並同意盛事科技股份有限公司kyomon社群網站「<span id='aggrementclick'>會員規範</span>&<span id='privacyclick'>隱私權條款</span>」及以上權利義務之相關條款";
	out+="                </label>";
	out+="            </fieldset>";
...
popmember=function(){//會員條款
	   ...
	   out+="        <div class='word-html'>";
		 //提醒過三次都不改錯..所以絕對不重貼了
		 out+="            <p>		 ■kyomon會員規範 </p>";
		 out+="            <p>		 歡迎來到kyomon社群網站（以下簡稱kyomon）！為了保障您的權益，在註冊前請先詳細閱讀本會員規範之所有內容，當您選擇完成註冊即視為您已閱讀完本會員規範，並同意遵守以下所有規範內容。</p>";
		 out+="            <p>		 若您不同意以下所述全部或部分規範內容，您即無法完成會員註冊，將無法使用kyomon網站部分服務或參與相關活動。</p>";
		 out+="            <p>		 一、會員服務條款</p>";
		 ...
		 out+="            <p>		 ５.所有申請使用盛事科技股份有限公司（kyomon）會員服務的使用者，都應該詳細閱讀下列使用條款，這些使用條款訂立的目的，是為了保護盛事科技股份有限公司（kyomon）會員服務的提供者以及所有使用者的利益，並構成使用者與盛事科技股份有限公司（kyomon）會員服務的提供者之間的契約，使用者完成註冊手續、或開始使用盛事科技股份有限公司所提供之會員服務時，即視為已知悉並同意本會員規範的所有約定。</p>";
		 out+="            <p>		 ６. 盛事科技股份有限公司（kyomon）針對本網站擁有最終解釋權。</p>";
		 out+="            <p>		 如您是法律上之無行為能力人或限制行為能力人(如未滿20歲之未成年人)，於加入會員前，請將本服務使用條款交由您的法定代理人(如父母、輔助人或監護人)閱讀，並得到其同意，您才可註冊及使用盛事科技股份有限公司（kyomon）所提供之會員服務。</p>";
		 out+="            <p>		 當您開始使用盛事科技股份有限公司（kyomon）所提供之註冊會員服務時，視同您的法定代理人(如父母、輔助人或監護人)已閱讀、了解並同意本服務條款。</p>";
		 out+="            <p>		 二、遵守會員規範：</p>";
		 out+="            <p>		 在您於kyomon註冊成為會員後，可以使用kyomon所提供之各種服務及</p>";
		 out+="            <p>		 kyomon之特定服務，您可能須於使用該特定服務前同意相關使用規範。當您使用kyomon服務時，即表示同意接受kyomon之會員規範及其他kyomon所公告之規範或注意事項之約束。</p>";
		 out+="            <p>		 三、會員</p>";
		 ...
		 out+="            <p>		 五、註冊資料：</p>";
		 out+="            <p>		 您同意於註冊時提供完整詳實且符合真實之個人資料，您所登錄之資料事後若有變更時，應隨時更新。若有需要由kyomon協助處理客戶服務事項時，</p>";
		 out+="            <p>		 kyomon會核對您的個人資料，若與註冊時所登錄之資料不符時，kyomon將無法對您提供相關服務。</p>";
		 out+="            <p>		 若您提供之個人資料有填寫不實或原登錄之資料不實而未更新，或是有任何誤導之嫌，kyomon將保留隨時終止您會員資格及使用kyomon之權利。您同意kyomon依法律或契約有需要通知您時，得以電子文件向您註冊時之電子郵件帳號為通知，並於通知送出時即視為產生送達之效力，請您提供正確且經常使用的電子郵件帳號，以維護您的權益。</p>";
		 out+="            <p>		 六、使用行為</p>";
		 ...
		 out+="            <p>		 八、隱私權政策：</p>";
		 out+="            <p>		 您所提供的註冊資訊及其他於利用本網站服務時所提供之個人資料，kyomon將依【隱私權政策】進行蒐集、利用與保護。</p>";
		 out+="            <p>		 九、會員內容：</p>";
		 out+="            <p>		 若您使用kyomon服務發表及分享您所創作之文字、美術、照片、視訊等著作，或其他利用kyomon服務所為之討論、對話等（以下稱「會員內容」）時，您同意聲明並擔保會員內容為您所自行創作，並未侵害任何第三人之智慧財產權或其他權益，亦未違反任何法令之規定。</p>";
		 out+="            <p>		 請注意：您須為您所提供之會員內容負各種法律上責任，若涉有違法情事，</p>";
		 out+="            <p>		 kyomon亦將於配合法院、檢調機關、政府機關相關程序提供相關資料。若涉有侵害他人智慧財產權或其他權益之情事者，kyomon得終止您全部或部分服務。</p>";
		 out+="            <p>		 為維護kyomon網站服務品質，您同意會員內容除須依據各該服務之板規或其他已公告之個別條款或細部規定為適當之發表外，亦不得有任何違反網路禮節、令人不愉快、令人厭惡、猥褻、暴力或其他kyomon認為不適當之內容。</p>";
		 out+="            <p>		 kyomon對於使用者內容並不會進行事前過濾，惟kyomon保留(但無義務)對於會員內容予以刪除或禁止存取之權利。</p>";
		 out+="            <p>		 會員內容之著作權，屬於您所享有。您同意無條件授權會員內容予kyomon，得為kyomon網站營運，或為行銷、宣傳kyomon網站等目的範圍內為利用，並得於前開目的範圍內再授權他人使用。如有其他利用需求，kyomon將另行取得您的授權。</p>";
		 out+="            <p>		 十、終止授權</p>";
		 ...
		 out+="            <p>		 十一、會員的義務與責任：</p>";
		 out+="            <p>		 會員對本身於kyomon或透過kyomon傳輸的一切內容自負全責，您亦不得將會員帳號同意他人使用或移轉予他人，並同意遵守下列規定：</p>";
		 out+="            <p>		 1.	會員承諾遵守中華民國相關法規及一切國際網際網路規定與慣例。</p>";
		 out+="            <p>		 2.	會員同意並保證不公布或傳送任何毀謗、不實、威脅、不雅、猥褻、不法、攻擊性、毀謗性或侵害他人智慧財產權的文字，圖片或任何形式的檔案於</p>";
		 out+="            <p>		 kyomon上。</p>";
		 out+="            <p>		 3.	會員同意不會於kyomon上從事廣告或販賣商品行為，包括虛擬寶物、遊戲點數卡或其他商品或服務之交易行為等。</p>";
		 out+="            <p>		 4.	會員同意避免在公眾討論區討論私人事務，發表文章時，請尊重他人的權益及隱私權。</p>";
		 out+="            <p>		 kyomon就會員的行為是否符合會員規範有最終決定權。若kyomon決定會員的行為違反本會員規範或任何法令，會員同意kyomon得隨時停止帳號使用權或清除帳號，並停止使用kyomon。會員在違反法律規定之情事，應自負法律責任。</p>";
		 out+="            <p>		 十二、免責事項</p>";
		 ...
		 out+="            <p>		 十三、服務之停止與更改： </p>";
		 out+="            <p>		 1.於發生下列情形之一時，kyomon有權停止或中斷提供服務：</p>";
		 out+="            <p>		  a)對kyomon之設備進行必要之保養及施工時。</p>";
		 out+="            <p>		  b)發生突發性之設備故障時。</p>";
		 out+="            <p>		 c)由於kyomon所申請之 ISP 業者無法提供服務時。</p>";
		 out+="            <p>		 d)因天災等不可抗力之因素致使kyomon無法提供服務時。</p>";
		 out+="            <p>		 c)其他本公司不可預測之因素。</p>";
		 out+="            <p>		 2.kyomon可能因公司或 ISP 業者網路系統軟硬體設備之故障、失靈或人為操作上之疏失而造成全部或部份中斷、暫時無法使用、延遲或造成資料傳輸或儲存上之錯誤、或遭第三人侵入系統篡改或偽造變造資料等，kyomon將盡力回復相關服務之正常運作，會員不得因此而要求任何補償。</p>";
		 out+="            <p>		 3.如因故kyomon網站須終止營運，kyomon將於終止前於網站公告， </p>";
		 out+="            <p>		 您應自行保留使用kyomon所生之各種資料或記錄。</p>";
		 out+="            <p>		 十四、保管及通知義務：</p>";
		 out+="            <p>		 您有責任維持密碼及帳號的機密安全。除可依法證明非您本身或授意他人所為者外，您必須完全負起因利用該密碼及帳號所進行之一切行為之責任。</p>";
		 out+="            <p>		 當密碼或帳號遭到未經授權之使用，或發生其他任何安全問題時，您必須立即通知kyomon，以減少相關損害。建議您於公用電腦使用完畢，務必登出您的帳號。因您未遵守本項約定所生之任何損失或損害，我們將無法亦不予負責。</p>";
		 out+="            <p>		 十五、特別同意事項：</p>";
		 out+="            <p>		 您同意於kyomon所發表之一切內容僅代表您個人之立場與行為，並同意承擔所有相關衍生之責任，kyomon不負任何責任。</p>";
		 out+="            <p>		 您亦同意若因其他會員行為造成您權利的損害或其他困擾時，不會對kyomon行使或主張任何權利或賠償。</p>";
		 out+="            <p>		 十六、責任限制：</p>";
		 out+="            <p>		 您認知並了解kyomon乃依其現狀及使用時之狀況提供服務，您須自行承擔使用kyomon網站服務時之風險。kyomon並未對網站服務可符合您使用上之需求及任何錯誤之修正為任何明示或默示的擔保。</p>";
		 out+="            <p>		 kyomon對您使用kyomon網站服務或與kyomon網站連結之其他網站下載的圖檔、軟體或資料等，不負任何擔保責任。您應於下載前自行斟酌與判斷前述資料之合適性、有效性、正確性、完整性、及是否侵害他人權利，以免遭受損失，kyomon對於該等損失不負任何賠償責任。</p>";
		 out+="            <p>		 您同意若依法kyomon須負賠償責任時，單一事件之賠償上限為您於該賠償事件發生前一個月使用本網站特定服務產生之費用。</p>";
		 out+="            <p>		 十七、擔保責任免除：</p>";
		 out+="            <p>		 1.kyomon保留隨時更改或調整各項服務內容之權利，無需事先通知會員。</p>";
		 out+="            <p>		 kyomon得依其判斷對於違反會員規範或相關規定之會員帳號終止其使用之權利。無論任何情形，就停止或更改服務或終止會員帳號使用所可能產生之困擾、不便或損害，會員同意不對kyomon有任何主張。</p>";
		 out+="            <p>		 2.kyomon保留將來新增、修改或刪除各項服務之全部或一部之權利，且不另行個別通知，會員不得因此而要求任何補償或賠償。</p>";
		 out+="            <p>		 3.廠商或個人可能透過kyomon之服務或經由服務連結至其他網站、營業處所提供商品買賣、服務或其他交易行為。會員若因此直接與該等廠商或個人直接進行交易，各該買賣或其他合約均僅存在您與各該廠商或個人兩造之間。kyomon除聲明不介入兩造之任何行為外，對於您所獲得的商品、服務或其他交易標的物亦不負任何擔保責任。</p>";
		 out+="            <p>		 4.kyomon提供之特定服務可能存在專屬之服務條款，在此情形下，雙方權利義務將依據該服務之專屬條款決定之。</p>";
		 out+="            <p>		 十八、廣告或促銷行為：</p>";
		 out+="            <p>		 kyomon上有關商業廣告及各種商品之促銷資訊，該等內容均係由廣告商或商品服務提供人所為，kyomon僅係提供刊登內容之平台。</p>";
		 out+="            <p>		 會員透過kyomon上所提供之商品、服務資訊，所購買之任何非由kyomon所直接販售之商品或服務，其間交易關係均存在於會員與商品或服務提供人間，與kyomon無關。</p>";
		 out+="            <p>		 十九、智慧財產權：</p>";
		 out+="            <p>		 kyomon刊出之所有著作及資料（例如文章、圖片等）內容，其著作權、專利權、商標權、營業秘密及其他智慧財產權，皆為盛事科技股份有限公司或該內容之提供者所有，且受中華民國法令及國際法律的保障。</p>";
		 out+="            <p>		 kyomon畫面資料之選擇、編排之版權為盛事科技股份有限公司所有，且受中華民國著作權法令及國際著作權法律的保障。非經本公司書面授權同意，不得以任何形式轉載、傳輸、傳播、散布、展示、出版、再製或利用</p>";
		 out+="            <p>		 kyomon內容的局部、全部的內容，以免觸犯相關法律規定。未經本公司書面同意，您不得擅自複製、進行還原工程（reverse engineering）、解編（de-compile）或反向組譯（disassemble）kyomon之任何功能或程式。</p>";
		 ...
		 out+="            <p>		 二十、連結：</p>";
		 out+="            <p>		 kyomon在網站或相關網頁上所提供之所有連結，可能連結到其他個人、公司或組織之網站，提供該連結之目的，僅為便利站友搜集或取得資訊，kyomon對於被連結之該等個人、公司或組織之網站上所提供之產品、服務或資訊，既不擔保其真實性、完整性、即時性或可信度，該等個人、公司或組織亦不因此而當然與kyomon有任何僱佣、委任、代理、合夥或其他類似之關係。</p>";
		 out+="            <p>		 二十一、損害賠償：</p>";
		 out+="            <p>		 因會員違反相關法令或違背本會員規範之任一條款，致kyomon或其關係企業、受僱人、受託人、代理人及其他相關履行輔助人因而受有損害或支出費用（包括且不限於因進行民事、刑事及行政程序所支出之合理律師費用）時，會員應自行負擔損害賠償責任或填補其費用。</p>";
		 out+="            <p>		 二十二、會員規範之修改：</p>";
		 out+="            <p>		 kyomon有權於任何時間修改或變更本服務條款之內容，建議您隨時注意該等修改或變更。您於任何修改或變更後繼續使用本服務，視為您已閱讀、瞭解並同意接受該等修改或變更。如果您不同意本服務條款的內容，或者您所屬的國家或地域排除本服務條款內容之全部或一部時，您應立即停止使用本服務。</p>";
		 ...
		 out+="            <p>		 本會員規範之解釋及適用以及會員因使用本服務而與kyomon間所生之權利義務關係，應依中華民國法令解釋適用之。因此所生之爭議，除法律另有規定者外，以中華民國台北地方法院為第一審管轄法院。</p>";
		 out+="            <p>		 二十五、其他規定</p>";
		 ...
		 out+="            <p>		 二十七、關於kyomon上的虛擬貨幣與相關活動</p>";
		 out+="            <p>		 1.kyomon網站設有累積升級功能，每位已註冊的會員在網站上進行活動即可能依盛事科技股份有限公司（kyomon）之規定累積貢獻值，當貢獻值累積到一定點數後就可依kyomon之公告活動內容規定參加盛事科技股份有限公司（kyomon）的活動。盛事科技股份有限公司（kyomon）保留變更或取消「貢獻值取得及使用內容方式」之權利，惟kyomon於變更或取消前會先為公告於kyomon網站，新的「貢獻值取得及使用內容方式」自公告時生效。</p>";
		 out+="            <p>		 2.任何利用程式Bug或其他不正當方法賺取貢獻值，或竄改貢獻值之行為，盛事科技股份有限公司（kyomon）都可收回會員不當累積的貢獻值，或可取消活動或宣佈該次活動無效、或以其他適當方式處理之。</p>";
		 ...
		 /*
		 ■kyomon會員規範
		 歡迎來到kyomon社群網站（以下簡稱kyomon）！為了保障您的權益，在註冊前請先詳細閱讀本會員規範之所有內容，當您選擇完成註冊即視為您已閱讀完本會員規範，並同意遵守以下所有規範內容。
		 若您不同意以下所述全部或部分規範內容，您即無法完成會員註冊，將無法使用kyomon網站部分服務或參與相關活動。
		 一、會員服務條款
		 ...
		 5.所有申請使用盛事科技股份有限公司（kyomon）會員服務的使用者，都應該詳細閱讀下列使用條款，這些使用條款訂立的目的，是為了保護盛事科技股份有限公司（kyomon）會員服務的提供者以及所有使用者的利益，並構成使用者與盛事科技股份有限公司（kyomon）會員服務的提供者之間的契約，使用者完成註冊手續、或開始使用盛事科技股份有限公司所提供之會員服務時，即視為已知悉並同意本會員規範的所有約定。
		 6. 盛事科技股份有限公司（kyomon）針對本網站擁有最終解釋權。
		 如您是法律上之無行為能力人或限制行為能力人(如未滿20歲之未成年人)，於加入會員前，請將本服務使用條款交由您的法定代理人(如父母、輔助人或監護人)閱讀，並得到其同意，您才可註冊及使用盛事科技股份有限公司（kyomon）所提供之會員服務。
		 當您開始使用盛事科技股份有限公司（kyomon）所提供之註冊會員服務時，視同您的法定代理人(如父母、輔助人或監護人)已閱讀、了解並同意本服務條款。
		 二、遵守會員規範：
		 在您於kyomon註冊成為會員後，可以使用kyomon所提供之各種服務及kyomon之特定服務，您可能須於使用該特定服務前同意相關使用規範。當您使用kyomon服務時，即表示同意接受kyomon之會員規範及其他kyomon所公告之規範或注意事項之約束。
		 三、會員
		 ...
		 五、註冊資料：
		 您同意於註冊時提供完整詳實且符合真實之個人資料，您所登錄之資料事後若有變更時，應隨時更新。若有需要由kyomon協助處理客戶服務事項時，
		 kyomon會核對您的個人資料，若與註冊時所登錄之資料不符時，kyomon將無法對您提供相關服務。
		 若您提供之個人資料有填寫不實或原登錄之資料不實而未更新，或是有任何誤導之嫌，kyomon將保留隨時終止您會員資格及使用kyomon之權利。您同意kyomon依法律或契約有需要通知您時，得以電子文件向您註冊時之電子郵件帳號為通知，並於通知送出時即視為產生送達之效力，請您提供正確且經常使用的電子郵件帳號，以維護您的權益。
		 六、使用行為
		 ...
		 八、隱私權政策：
		 您所提供的註冊資訊及其他於利用本網站服務時所提供之個人資料，kyomon將依【隱私權政策】進行蒐集、利用與保護。
		 九、會員內容：
		 若您使用kyomon服務發表及分享您所創作之文字、美術、照片、視訊等著作，或其他利用kyomon服務所為之討論、對話等（以下稱「會員內容」）時，您同意聲明並擔保會員內容為您所自行創作，並未侵害任何第三人之智慧財產權或其他權益，亦未違反任何法令之規定。
		 請注意：您須為您所提供之會員內容負各種法律上責任，若涉有違法情事，
		 kyomon亦將於配合法院、檢調機關、政府機關相關程序提供相關資料。若涉有侵害他人智慧財產權或其他權益之情事者，kyomon得終止您全部或部分服務。
		 為維護kyomon網站服務品質，您同意會員內容除須依據各該服務之板規或其他已公告之個別條款或細部規定為適當之發表外，亦不得有任何違反網路禮節、令人不愉快、令人厭惡、猥褻、暴力或其他kyomon認為不適當之內容。
		 kyomon對於使用者內容並不會進行事前過濾，惟kyomon保留(但無義務)對於會員內容予以刪除或禁止存取之權利。
		 會員內容之著作權，屬於您所享有。您同意無條件授權會員內容予kyomon，得為kyomon網站營運，或為行銷、宣傳kyomon網站等目的範圍內為利用，並得於前開目的範圍內再授權他人使用。如有其他利用需求，kyomon將另行取得您的授權。
		 十、終止授權
		 您使用本服務之行為若有任何違反法令或本使用條款或危害本網站或第三者權益之虞時，本公司有權不經告知您，立即暫時或永久終止您使用本服務之授權。
		 基於公司的運作，本網站有可能變更、或停止提供服務之全部或一部，使用者不可以因此而要求賠償或補償
		 十一、會員的義務與責任：
		 會員對本身於kyomon或透過kyomon傳輸的一切內容自負全責，您亦不得將會員帳號同意他人使用或移轉予他人，並同意遵守下列規定：
		 1.會員承諾遵守中華民國相關法規及一切國際網際網路規定與慣例。
		 2.會員同意並保證不公布或傳送任何毀謗、不實、威脅、不雅、猥褻、不法、攻擊性、毀謗性或侵害他人智慧財產權的文字，圖片或任何形式的檔案於 kyomon上。
		 3.會員同意不會於kyomon上從事廣告或販賣商品行為，包括虛擬寶物、遊戲點數卡或其他商品或服務之交易行為等。
		 4.會員同意避免在公眾討論區討論私人事務，發表文章時，請尊重他人的權益及隱私權。
		 kyomon就會員的行為是否符合會員規範有最終決定權。若kyomon決定會員的行為違反本會員規範或任何法令，會員同意kyomon得隨時停止帳號使用權或清除帳號，並停止使用kyomon。會員在違反法律規定之情事，應自負法律責任。
		 十二、免責事項
		 ...
		 十三、服務之停止與更改：
		 1.於發生下列情形之一時，kyomon有權停止或中斷提供服務：
		 a)對kyomon之設備進行必要之保養及施工時。
		 b)發生突發性之設備故障時。
		 c)由於kyomon所申請之 ISP 業者無法提供服務時。
		 d)因天災等不可抗力之因素致使kyomon無法提供服務時。
		 c)其他本公司不可預測之因素。
		 2.kyomon可能因公司或 ISP 業者網路系統軟硬體設備之故障、失靈或人為操作上之疏失而造成全部或部份中斷、暫時無法使用、延遲或造成資料傳輸或儲存上之錯誤、或遭第三人侵入系統篡改或偽造變造資料等，kyomon將盡力回復相關服務之正常運作，會員不得因此而要求任何補償。
		 3.如因故kyomon網站須終止營運，kyomon將於終止前於網站公告，
		 您應自行保留使用kyomon所生之各種資料或記錄。
		 十四、保管及通知義務：
		 您有責任維持密碼及帳號的機密安全。除可依法證明非您本身或授意他人所為者外，您必須完全負起因利用該密碼及帳號所進行之一切行為之責任。
		 當密碼或帳號遭到未經授權之使用，或發生其他任何安全問題時，您必須立即通知kyomon，以減少相關損害。建議您於公用電腦使用完畢，務必登出您的帳號。因您未遵守本項約定所生之任何損失或損害，我們將無法亦不予負責。
		 十五、特別同意事項：
		 您同意於kyomon所發表之一切內容僅代表您個人之立場與行為，並同意承擔所有相關衍生之責任，kyomon不負任何責任。
		 您亦同意若因其他會員行為造成您權利的損害或其他困擾時，不會對kyomon行使或主張任何權利或賠償。
		 十六、責任限制：
		 您認知並了解kyomon乃依其現狀及使用時之狀況提供服務，您須自行承擔使用kyomon網站服務時之風險。kyomon並未對網站服務可符合您使用上之需求及任何錯誤之修正為任何明示或默示的擔保。
		 kyomon對您使用kyomon網站服務或與kyomon網站連結之其他網站下載的圖檔、軟體或資料等，不負任何擔保責任。您應於下載前自行斟酌與判斷前述資料之合適性、有效性、正確性、完整性、及是否侵害他人權利，以免遭受損失，kyomon對於該等損失不負任何賠償責任。
		 您同意若依法kyomon須負賠償責任時，單一事件之賠償上限為您於該賠償事件發生前一個月使用本網站特定服務產生之費用。
		 十七、擔保責任免除：
		 1.kyomon保留隨時更改或調整各項服務內容之權利，無需事先通知會員。kyomon得依其判斷對於違反會員規範或相關規定之會員帳號終止其使用之權利。無論任何情形，就停止或更改服務或終止會員帳號使用所可能產生之困擾、不便或損害，會員同意不對kyomon有任何主張。
		 2.kyomon保留將來新增、修改或刪除各項服務之全部或一部之權利，且不另行個別通知，會員不得因此而要求任何補償或賠償。
		 3.廠商或個人可能透過kyomon之服務或經由服務連結至其他網站、營業處所提供商品買賣、服務或其他交易行為。會員若因此直接與該等廠商或個人直接進行交易，各該買賣或其他合約均僅存在您與各該廠商或個人兩造之間。kyomon除聲明不介入兩造之任何行為外，對於您所獲得的商品、服務或其他交易標的物亦不負任何擔保責任。
		 4.kyomon提供之特定服務可能存在專屬之服務條款，在此情形下，雙方權利義務將依據該服務之專屬條款決定之。
		 十八、廣告或促銷行為：
		 kyomon上有關商業廣告及各種商品之促銷資訊，該等內容均係由廣告商或商品服務提供人所為，kyomon僅係提供刊登內容之平台。
		 會員透過kyomon上所提供之商品、服務資訊，所購買之任何非由kyomon所直接販售之商品或服務，其間交易關係均存在於會員與商品或服務提供人間，與kyomon無關。
		 十九、智慧財產權：
		 kyomon刊出之所有著作及資料（例如文章、圖片等）內容，其著作權、專利權、商標權、營業秘密及其他智慧財產權，皆為盛事科技股份有限公司或該內容之提供者所有，且受中華民國法令及國際法律的保障。
		 kyomon畫面資料之選擇、編排之版權為盛事科技股份有限公司所有，且受中華民國著作權法令及國際著作權法律的保障。非經本公司書面授權同意，不得以任何形式轉載、傳輸、傳播、散布、展示、出版、再製或利用
		 kyomon內容的局部、全部的內容，以免觸犯相關法律規定。未經本公司書面同意，您不得擅自複製、進行還原工程（reverse engineering）、解編（de-compile）或反向組譯（disassemble）kyomon之任何功能或程式。
		 ...
		 二十、連結：
		 kyomon在網站或相關網頁上所提供之所有連結，可能連結到其他個人、公司或組織之網站，提供該連結之目的，僅為便利站友搜集或取得資訊，kyomon對於被連結之該等個人、公司或組織之網站上所提供之產品、服務或資訊，既不擔保其真實性、完整性、即時性或可信度，該等個人、公司或組織亦不因此而當然與kyomon有任何僱佣、委任、代理、合夥或其他類似之關係。
		 二十一、損害賠償：
		 因會員違反相關法令或違背本會員規範之任一條款，致kyomon或其關係企業、受僱人、受託人、代理人及其他相關履行輔助人因而受有損害或支出費用（包括且不限於因進行民事、刑事及行政程序所支出之合理律師費用）時，會員應自行負擔損害賠償責任或填補其費用。
		 二十二、會員規範之修改：
		 kyomon有權於任何時間修改或變更本服務條款之內容，建議您隨時注意該等修改或變更。您於任何修改或變更後繼續使用本服務，視為您已閱讀、瞭解並同意接受該等修改或變更。如果您不同意本服務條款的內容，或者您所屬的國家或地域排除本服務條款內容之全部或一部時，您應立即停止使用本服務。
		 ...
		 二十四、準據法及管轄法院：
		 本會員規範之解釋及適用以及會員因使用本服務而與kyomon間所生之權利義務關係，應依中華民國法令解釋適用之。因此所生之爭議，除法律另有規定者外，以中華民國台北地方法院為第一審管轄法院。
		 二十五、其他規定
		 ...
		 二十七、關於kyomon上的虛擬貨幣與相關活動
		 1.kyomon網站設有累積升級功能，每位已註冊的會員在網站上進行活動即可能依盛事科技股份有限公司（kyomon）之規定累積貢獻值，當貢獻值累積到一定點數後就可依kyomon之公告活動內容規定參加盛事科技股份有限公司（kyomon）的活動。盛事科技股份有限公司（kyomon）保留變更或取消「貢獻值取得及使用內容方式」之權利，惟kyomon於變更或取消前會先為公告於kyomon網站，新的「貢獻值取得及使用內容方式」自公告時生效。
		 2.任何利用程式Bug或其他不正當方法賺取貢獻值，或竄改貢獻值之行為，盛事科技股份有限公司（kyomon）都可收回會員不當累積的貢獻值，或可取消活動或宣佈該次活動無效、或以其他適當方式處理之。
