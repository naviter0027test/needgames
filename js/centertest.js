...
show_mypagefront=function(x){
	...
	tempitem.success(function(data){//回傳 data --data[0]都是確認正確  data[1]就是回傳的array  data[2]-->則是未定義..	
		...
		if(mem==sessionStorage.getItem("userid")){
			...
			out+="                            	<input type='file'  id='headpicform' style='top:10px;left:10px;display:none;' class='formfield instantupload fixer' name='headpic'  data-job='uploadheadb' data-form='headpicformb' data-pictarget='mypageheadpic' data-target='frontpicid' data-type='replace'>\n";
			out+="							  </div>\n";
			out+="							  </form>";
		}
		out+="							</div>\n";
...
//		}
		...
		if(m==sessionStorage.getItem("userid")){
			...
			out+="                      		<div class='formitem formitem_2'>\n";
			out+="                                <div id='locationvalue'>"+data[1]['lc']+"</div>\n";
			out+="                            </div>\n";
			out+="                            <div class='clr'></div>\n";
			out+="                    </div>\n";
			out+="                    <div class='formline'>\n";
			...
			out+="                      		<div class='formitem formitem_2'>\n";
			out+="                                <div id='locationvalue'>"+data[1]['tc']+"</div>\n";
			out+="                            </div>\n";
			out+="                            <div class='clr'></div>\n";
			out+="                    </div>\n";
			out+="                    <div class='formline'>\n";
			...
			out+="                      		<div class='formitem formitem_2'>\n";
			out+="                                <div id='locationvalue'>"+data[1]['allc']+"</div>\n";
			out+="                            </div>\n";
			out+="                            <div class='clr'></div>\n";
			out+="                    </div>\n";
