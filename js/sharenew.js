(function($){
	...
	popmember=function(){//會員條款
	   out="";
		 out+="            <span class='aggp'>		 歡迎來到ＮＥＥＤ社群網站（以下簡稱ＮＥＥＤ）！為了保障您的權益，在註冊前請先詳細閱讀本會員規範之所有內容，當您選擇完成註冊即視為您已閱讀完本會員規範，並同意遵守以下所有規範內容。</span>";
		 out+="            <span class='aggp'>		 若您不同意以下所述全部或部分規範內容，您即無法完成會員註冊，將無法使用ＮＥＥＤ網站部分服務或參與相關活動。</span>";
		 ...
		 out+="            <span class='aggh2'>		 ５.所有申請使用盛事科技股份有限公司（ＮＥＥＤ）會員服務的使用者，都應該詳細閱讀下列使用條款，這些使用條款訂立的目的，是為了保護盛事科技股份有限公司（ＮＥＥＤ）會員服務的提供者以及所有使用者的利益，並構成使用者與盛事科技股份有限公司（ＮＥＥＤ）會員服務的提供者之間的契約，使用者完成註冊手續、或開始使用盛事科技股份有限公司所提供之會員服務時，即視為已知悉並同意本會員規範的所有約定。</span>";
		 out+="            <span class='aggh2'>		 ６. 盛事科技股份有限公司（ＮＥＥＤ）針對本網站擁有最終解釋權。</span>";
		 out+="            <span class='aggp'>		 如您是法律上之無行為能力人或限制行為能力人(如未滿20歲之未成年人)，於加入會員前，請將本服務使用條款交由您的法定代理人(如父母、輔助人或監護人)閱讀，並得到其同意，您才可註冊及使用盛事科技股份有限公司（ＮＥＥＤ）所提供之會員服務。</span>";
		 out+="            <span class='aggp'>		 當您開始使用盛事科技股份有限公司（ＮＥＥＤ）所提供之註冊會員服務時，視同您的法定代理人(如父母、輔助人或監護人)已閱讀、了解並同意本服務條款。</span>";
		 out+="            <span class='aggh1'>		 二、遵守會員規範：</span>";
		 out+="            <span class='aggp'>		 在您於ＮＥＥＤ註冊成為會員後，可以使用ＮＥＥＤ所提供之各種服務及</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ之特定服務，您可能須於使用該特定服務前同意相關使用規範。當您使用ＮＥＥＤ服務時，即表示同意接受ＮＥＥＤ之會員規範及其他ＮＥＥＤ所公告之規範或注意事項之約束。</span>";
		 ...
		 out+="            <span class='aggint'>		 c.3. 為保護盛事科技股份有限公司（NEED）會員服務系統之安全或經營者</span>";
		 out+="            <span class='aggp'>		         之合法權益；</span>";
		 out+="            <span class='aggint'>		 c.4. 為保護其他使用者其他第三人的合法權益；</span>";
		 out+="            <span class='aggint'>		 c.5. 為維護盛事科技股份有限公司（NEED）會員服務系統的正常運作。</span>";
		 out+="            <span class='aggint'>		 d.     經會員註冊成功後，為增加會員服務範圍，不須另行註冊即享有本公司各項產品之會員資格，本公司將於各產品內進行會員資料的建檔、揭露、轉介、或交互運用，但本公司仍保有拒絕或暫停產品服務的權利。</span>";
		 out+="            <span class='aggint'>		 e.     NEED社群也自動接收並記錄您電腦和瀏覽器上的資料，包括 IP位址、  </span>";
		 out+="            <span class='aggp'>		          NEED社群cookie中的資料、使用之軟體和硬體以及您瀏覽的網頁紀錄。</span>";
		 out+="            <span class='aggp'>		         在您使用NEED社群產品及服務期間，NEED社群將資料用作以下用途：改善NEED社群產品與服務品質、聯絡您、進行研究，以及提供內部及外部客戶不載有個人資料之市場分析或業務報告。</span>";
		 ...
		 out+="            <span class='aggp'>		 您同意於註冊時提供完整詳實且符合真實之個人資料，您所登錄之資料事後若有變更時，應隨時更新。若有需要由ＮＥＥＤ協助處理客戶服務事項時，</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ會核對您的個人資料，若與註冊時所登錄之資料不符時，ＮＥＥＤ將無法對您提供相關服務。</span>";
		 out+="            <span class='aggp'>		 若您提供之個人資料有填寫不實或原登錄之資料不實而未更新，或是有任何誤導之嫌，ＮＥＥＤ將保留隨時終止您會員資格及使用ＮＥＥＤ之權利。您同意ＮＥＥＤ依法律或契約有需要通知您時，得以電子文件向您註冊時之電子郵件帳號為通知，並於通知送出時即視為產生送達之效力，請您提供正確且經常使用的電子郵件帳號，以維護您的權益。</span>";
		 ...
		 out+="            <span class='aggp'>		 您所提供的註冊資訊及其他於利用本網站服務時所提供之個人資料，ＮＥＥＤ將依【隱私權政策】進行蒐集、利用與保護。</span>";
		 out+="            <span class='aggh1'>		 九、會員內容：</span>";
		 out+="            <span class='aggp'>		 若您使用ＮＥＥＤ服務發表及分享您所創作之文字、美術、照片、視訊等著作，或其他利用ＮＥＥＤ服務所為之討論、對話等（以下稱「會員內容」）時，您同意聲明並擔保會員內容為您所自行創作，並未侵害任何第三人之智慧財產權或其他權益，亦未違反任何法令之規定。</span>";
		 out+="            <span class='aggp'>		 請注意：您須為您所提供之會員內容負各種法律上責任，若涉有違法情事，</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ亦將於配合法院、檢調機關、政府機關相關程序提供相關資料。若涉有侵害他人智慧財產權或其他權益之情事者，ＮＥＥＤ得終止您全部或部分服務。</span>";
		 out+="            <span class='aggp'>		 為維護ＮＥＥＤ網站服務品質，您同意會員內容除須依據各該服務之板規或其他已公告之個別條款或細部規定為適當之發表外，亦不得有任何違反網路禮節、令人不愉快、令人厭惡、猥褻、暴力或其他ＮＥＥＤ認為不適當之內容。</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ對於使用者內容並不會進行事前過濾，惟ＮＥＥＤ保留(但無義務)對於會員內容予以刪除或禁止存取之權利。</span>";
		 out+="            <span class='aggp'>		 會員內容之著作權，屬於您所享有。您同意無條件授權會員內容予ＮＥＥＤ，得為ＮＥＥＤ網站營運，或為行銷、宣傳ＮＥＥＤ網站等目的範圍內為利用，並得於前開目的範圍內再授權他人使用。如有其他利用需求，ＮＥＥＤ將另行取得您的授權。</span>";
		 ...
		 out+="            <span class='aggp'>		 會員對本身於ＮＥＥＤ或透過ＮＥＥＤ傳輸的一切內容自負全責，您亦不得將會員帳號同意他人使用或移轉予他人，並同意遵守下列規定：</span>";
		 ...
		 out+="            <span class='aggp'>		 ＮＥＥＤ上。</span>";
		 out+="            <span class='aggh2'>		 3.	會員同意不會於ＮＥＥＤ上從事廣告或販賣商品行為，包括虛擬寶物、遊戲點數卡或其他商品或服務之交易行為等。</span>";
		 out+="            <span class='aggh2'>		 4.	會員同意避免在公眾討論區討論私人事務，發表文章時，請尊重他人的權益及隱私權。</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ就會員的行為是否符合會員規範有最終決定權。若ＮＥＥＤ決定會員的行為違反本會員規範或任何法令，會員同意ＮＥＥＤ得隨時停止帳號使用權或清除帳號，並停止使用ＮＥＥＤ。會員在違反法律規定之情事，應自負法律責任。</span>";
		 ...
		 out+="            <span class='aggh2'>		 1.於發生下列情形之一時，ＮＥＥＤ有權停止或中斷提供服務：</span>";
		 out+="            <span class='aggint'>		  a)對ＮＥＥＤ之設備進行必要之保養及施工時。</span>";
		 out+="            <span class='aggint'>		  b)發生突發性之設備故障時。</span>";
		 out+="            <span class='aggint'>		 c)由於ＮＥＥＤ所申請之 ISP 業者無法提供服務時。</span>";
		 out+="            <span class='aggint'>		 d)因天災等不可抗力之因素致使ＮＥＥＤ無法提供服務時。</span>";
		 out+="            <span class='aggint'>		 c)其他本公司不可預測之因素。</span>";
		 out+="            <span class='aggh2'>		 2.ＮＥＥＤ可能因公司或 ISP 業者網路系統軟硬體設備之故障、失靈或人為操作上之疏失而造成全部或部份中斷、暫時無法使用、延遲或造成資料傳輸或儲存上之錯誤、或遭第三人侵入系統篡改或偽造變造資料等，ＮＥＥＤ將盡力回復相關服務之正常運作，會員不得因此而要求任何補償。</span>";
		 out+="            <span class='aggh2'>		 3.如因故ＮＥＥＤ網站須終止營運，ＮＥＥＤ將於終止前於網站公告， </span>";
		 out+="            <span class='aggp'>		 您應自行保留使用ＮＥＥＤ所生之各種資料或記錄。</span>";
		 ...
		 out+="            <span class='aggp'>		 當密碼或帳號遭到未經授權之使用，或發生其他任何安全問題時，您必須立即通知ＮＥＥＤ，以減少相關損害。建議您於公用電腦使用完畢，務必登出您的帳號。因您未遵守本項約定所生之任何損失或損害，我們將無法亦不予負責。</span>";
		 out+="            <span class='aggh1'>		 十五、特別同意事項：</span>";
		 out+="            <span class='aggp'>		 您同意於ＮＥＥＤ所發表之一切內容僅代表您個人之立場與行為，並同意承擔所有相關衍生之責任，ＮＥＥＤ不負任何責任。</span>";
		 out+="            <span class='aggp'>		 您亦同意若因其他會員行為造成您權利的損害或其他困擾時，不會對ＮＥＥＤ行使或主張任何權利或賠償。</span>";
		 out+="            <span class='aggh1'>		 十六、責任限制：</span>";
		 out+="            <span class='aggp'>		 您認知並了解ＮＥＥＤ乃依其現狀及使用時之狀況提供服務，您須自行承擔使用ＮＥＥＤ網站服務時之風險。ＮＥＥＤ並未對網站服務可符合您使用上之需求及任何錯誤之修正為任何明示或默示的擔保。</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ對您使用ＮＥＥＤ網站服務或與ＮＥＥＤ網站連結之其他網站下載的圖檔、軟體或資料等，不負任何擔保責任。您應於下載前自行斟酌與判斷前述資料之合適性、有效性、正確性、完整性、及是否侵害他人權利，以免遭受損失，ＮＥＥＤ對於該等損失不負任何賠償責任。</span>";
		 out+="            <span class='aggp'>		 您同意若依法ＮＥＥＤ須負賠償責任時，單一事件之賠償上限為您於該賠償事件發生前一個月使用本網站特定服務產生之費用。</span>";
		 out+="            <span class='aggh1'>		 十七、擔保責任免除：</span>";
		 out+="            <span class='aggh2'>		 1.ＮＥＥＤ保留隨時更改或調整各項服務內容之權利，無需事先通知會員。</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ得依其判斷對於違反會員規範或相關規定之會員帳號終止其使用之權利。無論任何情形，就停止或更改服務或終止會員帳號使用所可能產生之困擾、不便或損害，會員同意不對ＮＥＥＤ有任何主張。</span>";
		 out+="            <span class='aggh2'>		 2.ＮＥＥＤ保留將來新增、修改或刪除各項服務之全部或一部之權利，且不另行個別通知，會員不得因此而要求任何補償或賠償。</span>";
		 out+="            <span class='aggh2'>		 3.廠商或個人可能透過ＮＥＥＤ之服務或經由服務連結至其他網站、營業處所提供商品買賣、服務或其他交易行為。會員若因此直接與該等廠商或個人直接進行交易，各該買賣或其他合約均僅存在您與各該廠商或個人兩造之間。ＮＥＥＤ除聲明不介入兩造之任何行為外，對於您所獲得的商品、服務或其他交易標的物亦不負任何擔保責任。</span>";
		 out+="            <span class='aggh2'>		 4.ＮＥＥＤ提供之特定服務可能存在專屬之服務條款，在此情形下，雙方權利義務將依據該服務之專屬條款決定之。</span>";
		 out+="            <span class='aggh1'>		 十八、廣告或促銷行為：</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ上有關商業廣告及各種商品之促銷資訊，該等內容均係由廣告商或商品服務提供人所為，ＮＥＥＤ僅係提供刊登內容之平台。</span>";
		 out+="            <span class='aggp'>		 會員透過ＮＥＥＤ上所提供之商品、服務資訊，所購買之任何非由ＮＥＥＤ所直接販售之商品或服務，其間交易關係均存在於會員與商品或服務提供人間，與ＮＥＥＤ無關。</span>";
		 out+="            <span class='aggh1'>		 十九、智慧財產權：</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ刊出之所有著作及資料（例如文章、圖片等）內容，其著作權、專利權、商標權、營業秘密及其他智慧財產權，皆為盛事科技股份有限公司或該內容之提供者所有，且受中華民國法令及國際法律的保障。</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ畫面資料之選擇、編排之版權為盛事科技股份有限公司所有，且受中華民國著作權法令及國際著作權法律的保障。非經本公司書面授權同意，不得以任何形式轉載、傳輸、傳播、散布、展示、出版、再製或利用</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ內容的局部、全部的內容，以免觸犯相關法律規定。未經本公司書面同意，您不得擅自複製、進行還原工程（reverse engineering）、解編（de-compile）或反向組譯（disassemble）ＮＥＥＤ之任何功能或程式。</span>";
		 ...
		 out+="            <span class='aggp'>		 ＮＥＥＤ在網站或相關網頁上所提供之所有連結，可能連結到其他個人、公司或組織之網站，提供該連結之目的，僅為便利站友搜集或取得資訊，ＮＥＥＤ對於被連結之該等個人、公司或組織之網站上所提供之產品、服務或資訊，既不擔保其真實性、完整性、即時性或可信度，該等個人、公司或組織亦不因此而當然與ＮＥＥＤ有任何僱佣、委任、代理、合夥或其他類似之關係。</span>";
		 out+="            <span class='aggh1'>		 二十一、損害賠償：</span>";
		 out+="            <span class='aggp'>		 因會員違反相關法令或違背本會員規範之任一條款，致ＮＥＥＤ或其關係企業、受僱人、受託人、代理人及其他相關履行輔助人因而受有損害或支出費用（包括且不限於因進行民事、刑事及行政程序所支出之合理律師費用）時，會員應自行負擔損害賠償責任或填補其費用。</span>";
		 out+="            <span class='aggh1'>		 二十二、會員規範之修改：</span>";
		 out+="            <span class='aggp'>		 ＮＥＥＤ有權於任何時間修改或變更本服務條款之內容，建議您隨時注意該等修改或變更。您於任何修改或變更後繼續使用本服務，視為您已閱讀、瞭解並同意接受該等修改或變更。如果您不同意本服務條款的內容，或者您所屬的國家或地域排除本服務條款內容之全部或一部時，您應立即停止使用本服務。</span>";
		 ...
		 out+="            <span class='aggp'>		 本會員規範之解釋及適用以及會員因使用本服務而與ＮＥＥＤ間所生之權利義務關係，應依中華民國法令解釋適用之。因此所生之爭議，除法律另有規定者外，以中華民國台北地方法院為第一審管轄法院。</span>";
		 ...
		 out+="            <span class='aggh1'>		 二十七、關於ＮＥＥＤ上的虛擬貨幣與相關活動</span>";
		 out+="            <span class='aggh2'>		 1.ＮＥＥＤ網站設有累積升級功能，每位已註冊的會員在網站上進行活動即可能依盛事科技股份有限公司（ＮＥＥＤ）之規定累積貢獻值，當貢獻值累積到一定點數後就可依ＮＥＥＤ之公告活動內容規定參加盛事科技股份有限公司（ＮＥＥＤ）的活動。盛事科技股份有限公司（ＮＥＥＤ）保留變更或取消「貢獻值取得及使用內容方式」之權利，惟ＮＥＥＤ於變更或取消前會先為公告於ＮＥＥＤ網站，新的「貢獻值取得及使用內容方式」自公告時生效。</span>";
		 out+="            <span class='aggh2'>		 2.任何利用程式Bug或其他不正當方法賺取貢獻值，或竄改貢獻值之行為，盛事科技股份有限公司（ＮＥＥＤ）都可收回會員不當累積的貢獻值，或可取消活動或宣佈該次活動無效、或以其他適當方式處理之。</span>";
...
/*
	   ...
	   out+="<span class='aggh2'>2.當您使用本站服務時，即表示您同意及遵守本服務條款的規定事項及相關法律之規定。</span>";
	   out+="<span class='aggh2'>3.本站保留有審核加入會員資格及有解除其會員資格之權利。</span>";
	   out+="<span class='aggh2'>4.本會員服務條款之修訂，適用於所有會員，當本站修訂本服務條款時，將於本站上公告。</span>";
	   out+="<span class='aggh2'>5.所有申請使用盛事科技股份有限公司（ＮＥＥＤ）會員服務的使用者，都應該詳細閱讀下列使用條款，這些使用條款訂立的目的，是為了保護盛事科技股份有限公司（ＮＥＥＤ）會員服務的提供者以及所有使用者的利益，並構成使用者與盛事科技股份有限公司（ＮＥＥＤ）會員服務的提供者之間的契約，使用者完成註冊手續、或開始使用盛事科技股份有限公司所提供之會員服務時，即視為已知悉並同意本會員規範的所有約定。</span>";
	   out+="<span class='aggp'>如您是法律上之無行為能力人或限制行為能力人(如未滿20歲之未成年人)，於加入會員前，請將本服務使用條款交由您的法定代理人(如父母、輔助人或監護人)閱讀，並得到其同意，您才可註冊及使用盛事科技股份有限公司（ＮＥＥＤ）所提供之會員服務。</span>";
	   out+="<span class='aggp'>當您開始使用盛事科技股份有限公司（ＮＥＥＤ）所提供之註冊會員服務時，視同您的法定代理人(如父母、輔助人或監護人)已閱讀、了解並同意本服務條款。</span>";
	   out+="<span class='aggh1'>二、遵守會員規範：</span>";
	   out+="<span class='aggp'>在您於ＮＥＥＤ註冊成為會員後，可以使用ＮＥＥＤ所提供之各種服務及ＮＥＥＤ之特定服務，您可能須於使用該特定服務前同意相關使用規範。當您使用ＮＥＥＤ服務時，即表示同意接受ＮＥＥＤ之會員規範及其他ＮＥＥＤ所公告之規範或注意事項之約束。</span>";
	   out+="<span class='aggh1'>三、會員</span>";
	   out+="<span class='aggh2'>1.使用本站所提供之會員服務時，須以加入會員時所登錄之帳號及密碼使用之。</span>";
	   out+="<span class='aggh2'>2.會員須善盡管理會員帳號及密碼之責任。對於使用該會員之帳號及密碼(不論會員本身或其他人)利用本站服務所造成或衍生之所有行為及結果，會員須自行負擔全部法律責任。</span>";
	   out+="<span class='aggh2'>3.會員之帳號及密碼遺失，或發現無故遭第三者盜用時，應立即通知本站連絡掛失。若因未即時通知，導致本站無法有效防止及修改時，所造成的所有損失，會員應自負全責。</span>";
	   ...
	   out+="<span class='aggh2'>5.會員應妥善保管密碼，不可將密碼洩露或提供給他人知道或使用；以同一個會員身分證字號和密碼使用本服務所進行的所有行為，都將被認為是該會員本人和密碼持有人的行為。</span>";
	   out+="<span class='aggh2'>6.會員如果發現或懷疑有第三人使用其會員身分證字號或密碼，應該立即通知本公司，採取必要的防範措施。但上述通知不得解釋為本公司對會員負有任何形式之賠償或補償之責任或義務。</span>";
	   out+="<span class='aggh2'>五、註冊資料：</span>";
	   out+="<span class='aggp'>您同意於註冊時提供完整詳實且符合真實之個人資料，您所登錄之資料事後若有變更時，應隨時更新。若有需要由ＮＥＥＤ協助處理客戶服務事項時，ＮＥＥＤ會核對您的個人資料，若與註冊時所登錄之資料不符時，ＮＥＥＤ將無法對您提供相關服務。</span>";
	   out+="<span class='aggp'>若您提供之個人資料有填寫不實或原登錄之資料不實而未更新，或是有任何誤導之嫌，ＮＥＥＤ將保留隨時終止您會員資格及使用ＮＥＥＤ之權利。</span>";
	   out+="<span class='aggp'>您同意ＮＥＥＤ依法律或契約有需要通知您時，得以電子文件向您註冊時之電子郵件帳號為通知，並於通知送出時即視為產生送達之效力，請您提供正確且經常使用的電子郵件帳號，以維護您的權益。</span>";
	   out+="<span class='aggh1'>六、使用行為</span>";
	   out+="<span class='aggh2'>1.您使用本服務之一切行為必須符合當地或國際相關法令規範；對於使用者的一切行為，您須自行負擔全部法律責任。</span>";
	   out+="<span class='aggh2'>2.您同意絕不為非法之目的或以非法方式使用本服務，與確實遵守中華民國相關法規及網際網路之國際慣例，並保證不得利用本服務從事侵害他人權益或違法之行為，否則您須自行負擔全部法律責任。</span>";
	   out+="<span class='aggh2'>3.您於使用本站會員服務時應遵守以下規則：</span>";
	   ...
	   out+="<span class='aggint'> b)不得使用違反公共秩序或善良風俗或其他不法之文字。</span>";
	   out+="<span class='aggint'> c) 不得使用強烈政治、宗教色彩的偏激言論。</span>";
	   out+="<span class='aggint'> d)未經本公司許可不得利用本服務或本網站所提供其他資源從事任何商業交易行為。</span>";
	   out+="<span class='aggint'> e)不得違反本站「會員規範」內容。</span>";
	   out+="<span class='aggh1'>七、本公司專有權利</span>";
	   out+="<span class='aggh2'>1.本服務所載，或本服務所連結之一切軟體或內容，或本公司之廣告商或合夥人所提供之內容，均受其著作權或其他專有權利或法律所保障。</span>";
	   out+="<span class='aggh2'>2.當您傳輸資料至本公司提供之服務時，您即同意此一資料為全開放性(任何人均可瀏覽)。您授權並許可本公司得以重製、修飾、改編或以其他形式使用該內容之全部或一部分，及利用該內容製作衍生著作。衍生著作之著作權悉歸本公司所有。</span>";
	   ...
	   out+="<span class='aggh1'>九、會員內容：</span>";
	   out+="<span class='aggp'>若您使用ＮＥＥＤ服務發表及分享您所創作之文字、美術、照片、視訊等著作，或其他利用ＮＥＥＤ服務所為之討論、對話等（以下稱「會員內容」）時，您同意聲明並擔保會員內容為您所自行創作，並未侵害任何第三人之智慧財產權或其他權益，亦未違反任何法令之規定。</span>";
	   out+="<span class='aggp'>請注意：您須為您所提供之會員內容負各種法律上責任，若涉有違法情事，ＮＥＥＤ亦將於配合法院、檢調機關、政府機關相關程序提供相關資料。若涉有侵害他人智慧財產權或其他權益之情事者，ＮＥＥＤ得終止您全部或部分服務。</span>";
	   out+="<span class='aggp'>為維護ＮＥＥＤ網站服務品質，您同意會員內容除須依據各該服務之板規或其他已公告之個別條款或細部規定為適當之發表外，亦不得有任何違反網路禮節、令人不愉快、令人厭惡、猥褻、暴力或其他ＮＥＥＤ認為不適當之內容。</span>";
	   out+="<span class='aggp'>ＮＥＥＤ對於使用者內容並不會進行事前過濾，惟ＮＥＥＤ保留(但無義務)對於會員內容予以刪除或禁止存取之權利。</span>";
	   out+="<span class='aggp'>會員內容之著作權，屬於您所享有。您同意無條件授權會員內容予ＮＥＥＤ，得為ＮＥＥＤ網站營運，或為行銷、宣傳ＮＥＥＤ網站等目的範圍內為利用，並得於前開目的範圍內再授權他人使用。如有其他利用需求，ＮＥＥＤ將另行取得您的授權。</span>";
	   out+="<span class='aggh1'>十、終止授權</span>";
	   out+="<span class='aggp'>您使用本服務之行為若有任何違反法令或本使用條款或危害本網站或第三者權益之虞時，本公司有權不經告知您，立即暫時或永久終止您使用本服務之授權。基於公司的運作，本網站有可能變更、或停止提供服務之全部或一部，使用者不可以因此而要求賠償或補償。</span>";
	   out+="<span class='aggh1'>十一、會員的義務與責任：</span>";
	   out+="<span class='aggp'>會員對本身於ＮＥＥＤ或透過ＮＥＥＤ傳輸的一切內容自負全責，您亦不得將會員帳號同意他人使用或移轉予他人，並同意遵守下列規定：</span>";
	   out+="<span class='aggh2'>1.	會員承諾遵守中華民國相關法規及一切國際網際網路規定與慣例。</span>";
	   out+="<span class='aggh2'>2.	會員同意並保證不公布或傳送任何毀謗、不實、威脅、不雅、猥褻、不法、攻擊性、毀謗性或侵害他人智慧財產權的文字，圖片或任何形式的檔案於ＮＥＥＤ上。</span>";
	   out+="<span class='aggh2'>3.	會員同意不會於ＮＥＥＤ上從事廣告或販賣商品行為，包括虛擬寶物、遊戲點數卡或其他商品或服務之交易行為等。</span>";
	   out+="<span class='aggh2'>4.	會員同意避免在公眾討論區討論私人事務，發表文章時，請尊重他人的權益及隱私權。</span>";
	   out+="<span class='aggp'>ＮＥＥＤ就會員的行為是否符合會員規範有最終決定權。若ＮＥＥＤ決定會員的行為違反本會員規範或任何法令，會員同意ＮＥＥＤ得隨時停止帳號使用權或清除帳號，並停止使用ＮＥＥＤ。會員在違反法律規定之情事，應自負法律責任。</span>";
	   out+="<span class='aggh1'>十二、免責事項</span>";
	   ...
	   out+="<span class='aggh1'>十三、服務之停止與更改：</span>";
	   out+="<span class='aggh2'>1.	於發生下列情形之一時，ＮＥＥＤ有權停止或中斷提供服務：</span>";
	   out+="<span class='aggint'>。對ＮＥＥＤ之設備進行必要之保養及施工時</span>";
	   out+="<span class='aggint'>。發生突發性之設備故障時</span>";
	   out+="<span class='aggint'>。由於ＮＥＥＤ所申請之 ISP 業者無法提供服務時</span>";
	   out+="<span class='aggint'>。因天災等不可抗力之因素致使ＮＥＥＤ無法提供服務時</span>";
	   out+="<span class='aggint'>。其他本公司不可預測之因素。</span>";
	   out+="<span class='aggh2'>2.	ＮＥＥＤ可能因公司或 ISP 業者網路系統軟硬體設備之故障、失靈或人為操作上之疏失而造成全部或部份中斷、暫時無法使用、延遲或造成資料傳輸或儲存上之錯誤、或遭第三人侵入系統篡改或偽造變造資料等，ＮＥＥＤ將盡力回復相關服務之正常運作，會員不得因此而要求任何補償。</span>";
	   out+="<span class='aggh2'>3.	如因故ＮＥＥＤ網站須終止營運，ＮＥＥＤ將於終止前於網站公告， 您應自行保留使用ＮＥＥＤ所生之各種資料或記錄。</span>";
	   out+="<span class='aggh1'>十四、保管及通知義務：</span>";
	   out+="<span class='aggp'>您有責任維持密碼及帳號的機密安全。除可依法證明非您本身或授意他人所為者外，您必須完全負起因利用該密碼及帳號所進行之一切行為之責任。當密碼或帳號遭到未經授權之使用，或發生其他任何安全問題時，您必須立即通知ＮＥＥＤ，以減少相關損害。建議您於公用電腦使用完畢，務必登出您的帳號。因您未遵守本項約定所生之任何損失或損害，我們將無法亦不予負責。</span>";
	   out+="<span class='aggh1'>十五、特別同意事項：</span>";
	   out+="<span class='aggp'>您同意於ＮＥＥＤ所發表之一切內容僅代表您個人之立場與行為，並同意承擔所有相關衍生之責任，ＮＥＥＤ不負任何責任。您亦同意若因其他會員行為造成您權利的損害或其他困擾時，不會對ＮＥＥＤ行使或主張任何權利或賠償。</span>";
	   out+="<span class='aggh1'>十六、責任限制：</span>";
	   out+="<span class='aggp'>您認知並了解ＮＥＥＤ乃依其現狀及使用時之狀況提供服務，您須自行承擔使用ＮＥＥＤ網站服務時之風險。ＮＥＥＤ並未對網站服務可符合您使用上之需求及任何錯誤之修正為任何明示或默示的擔保。</span>";
	   out+="<span class='aggh2'>ＮＥＥＤ對您使用ＮＥＥＤ網站服務或與ＮＥＥＤ網站連結之其他網站下載的圖檔、軟體或資料等，不負任何擔保責任。您應於下載前自行斟酌與判斷前述資料之合適性、有效性、正確性、完整性、及是否侵害他人權利，以免遭受損失，ＮＥＥＤ對於該等損失不負任何賠償責任。</span>";
	   out+="<span class='aggh2'>您同意若依法ＮＥＥＤ須負賠償責任時，單一事件之賠償上限為您於該賠償事件發生前一個月使用本網站特定服務產生之費用。</span>";
	   out+="<span class='aggh1'>十七、擔保責任免除：</span>";
	   out+="<span class='aggh2'>1.	ＮＥＥＤ保留隨時更改或調整各項服務內容之權利，無需事先通知會員。ＮＥＥＤ得依其判斷對於違反會員規範或相關規定之會員帳號終止其使用之權利。無論任何情形，就停止或更改服務或終止會員帳號使用所可能產生之困擾、不便或損害，會員同意不對ＮＥＥＤ有任何主張。</span>";
	   out+="<span class='aggh2'>2.	ＮＥＥＤ保留將來新增、修改或刪除各項服務之全部或一部之權利，且不另行個別通知，會員不得因此而要求任何補償或賠償。</span>";
	   out+="<span class='aggh2'>3.	廠商或個人可能透過ＮＥＥＤ之服務或經由服務連結至其他網站、營業處所提供商品買賣、服務或其他交易行為。會員若因此直接與該等廠商或個人直接進行交易，各該買賣或其他合約均僅存在您與各該廠商或個人兩造之間。ＮＥＥＤ除聲明不介入兩造之任何行為外，對於您所獲得的商品、服務或其他交易標的物亦不負任何擔保責任。</span>";
	   out+="<span class='aggh2'>4.	ＮＥＥＤ提供之特定服務可能存在專屬之服務條款，在此情形下，雙方權利義務將依據該服務之專屬條款決定之。</span>";
	   out+="<span class='aggh1'>十八、廣告或促銷行為：</span>";
	   out+="<span class='aggp'>ＮＥＥＤ上有關商業廣告及各種商品之促銷資訊，該等內容均係由廣告商或商品服務提供人所為，ＮＥＥＤ僅係提供刊登內容之平台。會員透過ＮＥＥＤ上所提供之商品、服務資訊，所購買之任何非由ＮＥＥＤ所直接販售之商品或服務，其間交易關係均存在於會員與商品或服務提供人間，與ＮＥＥＤ無關。</span>";
	   out+="<span class='aggh1'>十九、智慧財產權：</span>";
	   out+="<span class='aggp'>ＮＥＥＤ刊出之所有著作及資料（例如文章、圖片等）內容，其著作權、專利權、商標權、營業秘密及其他智慧財產權，皆為盛事科技股份有限公司或該內容之提供者所有，且受中華民國法令及國際法律的保障。</span>";
	   out+="<span class='aggp'>ＮＥＥＤ畫面資料之選擇、編排之版權為盛事科技股份有限公司所有，且受中華民國著作權法令及國際著作權法律的保障。非經本公司書面授權同意，不得以任何形式轉載、傳輸、傳播、散布、展示、出版、再製或利用ＮＥＥＤ內容的局部、全部的內容，以免觸犯相關法律規定。未經本公司書面同意，您不得擅自複製、進行還原工程（reverse engineering）、解編（de-compile）或反向組譯（disassemble）ＮＥＥＤ之任何功能或程式。</span>";
	   out+="<span class='aggp'>除本公司外任何人不得逕行使用、修改、重製、公開播送、改作、散布、發行、公開發表、進行還原工程、解編或反向組譯。如欲引用或轉載前述之軟體、程式或網站內容，必須依法取得本網站或其他權利人的事前書面同意。如有違反之情事，您應對本網站或其他權利人負損害賠償責任（包括但不限於訴訟費用及律師費用等）。</span>";
	   out+="<span class='aggh1'>二十、連結：</span>";
	   out+="<span class='aggp'>ＮＥＥＤ在網站或相關網頁上所提供之所有連結，可能連結到其他個人、公司或組織之網站，提供該連結之目的，僅為便利站友搜集或取得資訊，ＮＥＥＤ對於被連結之該等個人、公司或組織之網站上所提供之產品、服務或資訊，既不擔保其真實性、完整性、即時性或可信度，該等個人、公司或組織亦不因此而當然與ＮＥＥＤ有任何僱佣、委任、代理、合夥或其他類似之關係。</span>";
	   out+="<span class='aggh1'>二十一、損害賠償：</span>";
	   out+="<span class='aggp'>因會員違反相關法令或違背本會員規範之任一條款，致ＮＥＥＤ或其關係企業、受僱人、受託人、代理人及其他相關履行輔助人因而受有損害或支出費用（包括且不限於因進行民事、刑事及行政程序所支出之合理律師費用）時，會員應自行負擔損害賠償責任或填補其費用。</span>";
	   out+="<span class='aggh1'>二十二、會員規範之修改：</span>";
	   out+="<span class='aggp'>ＮＥＥＤ保留隨時修改本會員規範之權利，ＮＥＥＤ修改會員規範時，將於首頁及站務討論區內公告修改之內容，建議您經常上網注意該等公告。若會員不同意修改的內容，請勿繼續使用ＮＥＥＤ。如果會員繼續使用ＮＥＥＤ，將視為會員已同意並接受本會員規範等增訂或修改內容之約束。</span>";
	   out+="<span class='aggp'>當您開始使用本服務時，即表示您已充分閱讀、瞭解與同意接受本條款之內容。本公司有權於任何時間修改與變更本條款之內容，並將不個別通知會員，建議您定期查閱本服務條款。如您於本條款修改與變更後仍繼續使用本服務，則視為您已閱讀、瞭解與同意接受本條款修改或變更。</span>";
	   out+="<span class='aggp'>本公司有權暫時或永久修改或中止提供本服務給您，您不得因此要求任何賠償。</span>";
	   out+="<span class='aggh1'>二十三、個別條款之效力：</span>";
	   out+="<span class='aggp'>本會員規範所定之任何會員條款之全部或部份無效時，不影響其他條款之效力。</span>";
	   ...
	   out+="<span class='aggh2'>2.若會員決定終止本公司會員資格，有義務經由本公司所提供之機制通知本公司，本公司將儘快註銷您的會員資料（以本公司發出通知日期為準），註銷後即喪失所有本公司提供之權益。</span>";
	   out+="<span class='aggh1'>二十七、關於ＮＥＥＤ上的虛擬貨幣與相關活動</span>";
	   out+="<span class='aggh2'>1.ＮＥＥＤ網站設有貢獻值升級功能，每位已註冊的會員在網站上進行活動即可能依盛事科技股份有限公司（ＮＥＥＤ）之規定累積貢獻值，當貢獻值點數累積到一定點數後就可依ＮＥＥＤ之公告活動內容規定參加盛事科技股份有限公司（ＮＥＥＤ）的活動。盛事科技股份有限公司（ＮＥＥＤ）保留變更或取消「貢獻值取得及使用內容方式」之權利，惟ＮＥＥＤ於變更或取消前會先為公告於ＮＥＥＤ網站，新的「貢獻值取得及使用內容方式」自公告時生效。</span>";
	   out+="<span class='aggh2'>2.任何利用程式Bug或其他不正當方法賺取貢獻值，或竄改貢獻值之行為，盛事科技股份有限公司（ＮＥＥＤ）都可收回會員不當累積的貢獻值，或可取消活動或宣佈該次活動無效、或以其他適當方式處理之。</span>";
	   out+="<span class='aggh2'>3.活動之中獎會員應自行負擔所有依政府法令規定之義務，例如稅賦。</span>";
	   out+="<span class='aggh2'>4.會員如係無行為能力人，應由法定代理人或監護人代該會員以該會員帳號參加活動。會員如係限制行為能力人，其若欲參加活動應得法定代理人或監護人允許或輔助人之同意。</span>";
		 */
		popbaseu("會員規範",out,"");
	}
	popprivacy=function(){//隱私
		var out="";
		out+="            <span class='aggp'>		 ■NEED社群平台隱私權政策</span>";
		out+="            <span class='aggp'>		 「NEED社群平台」是由「盛事科技股份有限公司」所經營；為了支持個人資料的保護，以維護線上隱私權，「NEED社群平台」謹以下列聲明，對外說明「NEED社群平台」相關網站在線上搜集使用者個人資料的方式、範圍、利用方法、以及查詢或更正的方式等事項</span>";
		...
		out+="            <span class='aggp'>		 本隱私權政策適用於NEED社群平台網站（本站）相關個人資料蒐集、處理及利用事宜。</span>";
		out+="            <span class='aggp'>		 本隱私權保護政策不適用於NEED社群平台以外的網站，您認知並了解瀏覽本站服務時，在某些情形下，您可能會因超連結而被導致第三者所提供之網站。例如：點選廣告、閱讀某則資訊或網友張貼之內容。本隱私權政策不適用於經前述超連結所指向的網站，因此，誠摯地在此提醒您，當您離開NEED社群平台進入其他網站時，請別忘了先閱讀該網站所提供的隱私權條款，再決定您是否繼續接受該網站的服務。</span>";
		out+="            <span class='aggp'>		 ◎個人資料取得</span>";
		out+="            <span class='aggp'>		 「NEED社群平台」會記錄使用者上站的位址、以及在「NEED社群平台」相關網站內的瀏覽活動等資料，但是這些資料僅供作流量分析和網路行為調查，以便於改善「NEED社群平台」相關網站的服務品質，這些資料也只是總量上的分析，不會和特定個人相連繫。</span>";
		out+="            <span class='aggp'>		 在某些情況下，例如當使用者要求加入會員或參加其他活動時，「NEED社群平台」相關網站或其合作對象可能會要求使用者登錄個人資料，以便於和使用者聯繫並提供服務；在此等情況下，「NEED社群平台」相關網站或其合作對象將明白告知使用者此等事實，如果使用者選擇不接收任何廣告或聯繫資訊，「NEED社群平台」將完全予以尊重。</span>";
		out+="            <span class='aggp'>		 「NEED社群平台」相關網站或網頁都可能包含其他網站或網頁的連結，對於此等不屬於「NEED社群平台」之網站或網頁，不論關於其內容或隱私權政策，均與「NEED社群平台」無關。</span>";
		out+="            <span class='aggp'>		 ◎個人資料蒐集應告知事項</span>";
		out+="            <span class='aggp'>		 蒐集主體：盛事科技股份有限公司</span>";
		...
		out+="            <span class='aggp'>		 NEED社群平台將於下述情形蒐集您的個人資料：</span>";
		out+="            <span class='aggp'>		 1.當您加入NEED社群平台會員時，我們會要求您填寫基本的個人資料。</span>";
		...
		out+="            <span class='aggp'>		 當您在NEED社群平台註冊成為會員後，除系統禁止變更之資料（例如：姓名、性別、生日、身份證字號等）外，您可以隨時利用您的會員帳號和密碼更改您原先提供的資料，以確保其正確性。</span>";
		out+="            <span class='aggp'>		 您認知並了解您所能修改的資料並不包括您以往在本站之服務內容記錄。</span>";
		out+="            <span class='aggp'>		 您認知並同意NEED社群平台於會員帳號刪除時，您的個人資料將保留至少 6 個月，以備相關爭議查證之用。為避免他人在帳號刪除時，重新註冊相同的會員帳號產生身分混淆困擾，該等帳號將保留不提供後續註冊使用。</span>";
		out+="            <span class='aggp'>		 ◎個人資料的揭露：</span>";
		out+="            <span class='aggp'>		 除依本隱私權政策為利用外，NEED社群平台不會在未經您同意的狀況下向任何人出售或提供您的個人資料。您同意NEED社群平台得於下述情形對外利用或揭露您的個人資料：</span>";
		out+="            <span class='aggp'>		 1.若您的行為違反NEED社群平台的服務條款，或可能損害NEED社群平台權益，或您的行為已導致任何人遭受損害，揭露您的個人資料是為了辨識、聯絡或採取法律行動所必要者。</span>";
		out+="            <span class='aggp'>		 2.檢警調或司法單位或其他有權機關依法或基於公共利益，要求NEED社群平台提供特定個人資料時，經NEED社群平台考量依法或基於公共利益予以配合者。</span>";
		...
		out+="            <span class='aggp'>		 「Cookie」是一種儲存於使用者電腦端的小型資訊檔案，可配合瀏覽器的使用作為使用者電腦與網站互動時識別或讀取使用者的偏好設定之用，為會員制網站所普遍使用。NEED社群平台為提昇使用者使用本站之便利性，若您的瀏覽器的偏好設定允許cookie，NEED社群平台網站伺服器將會送出 cookie 至您的電腦。您可以隨時變更您的瀏覽器的設定，決定是否允許NEED社群平台網站設定或讀取您電腦端的 cookie。</span>";
		out+="            <span class='aggp'>		 ◎兒童隱私保護：</span>";
		out+="            <span class='aggp'>		 NEED社群平台網站並未刻意設計或提供吸引兒童（未滿12歲）內容或機制，亦無意透過本站蒐集兒童或其法定代理人之個人資料。然而社群網站內容來源複雜，為確保兒童隱私權，若您為兒童，請勿註冊本站會員，並避免與陌生網友互動。</span>";
		...
		out+="            <span class='aggp'>		 ■NEED社群平台著作權聲明</span>";
		out+="            <span class='aggp'>		 會員於使用本站服務或於本站發表圖文或其他著作前，請您先同意下列事項，若您不同意下列事項， 請勿使用本站服務或於本站發表著作。 </span>";
		out+="            <span class='aggp'>		 1.您保證您係為您所發表於NEED社群平台之文章及其他各種著作之著作人，或您確有得到著作權人之授權而發表，否則應對NEED社群平台負損害賠償責任。</span>";
		out+="            <span class='aggp'>		 2. NEED社群平台會員於NEED社群平台所發表之文章、圖像或其他各種著作之著作權為其著作權人所有。 </span>";
		out+="            <span class='aggp'>		 3. 若是您要重製、公開口述、公開播送、公開上映、公開演出、公開傳輸、改作、散布、公開展示、發行或公開發表任何NEED社群平台內登載之任何內容，請先得到著作權人之同意。尊重智慧財產權是您應盡的義務，如有違反，您應對權利人負損害賠償責任。</span>";
		out+="            <span class='aggp'>		 4.您若認為NEED社群平台網站內某些內容涉及侵權或有其他不妥之處，請您逕向該內容提供者反應意見。</span>";
		out+="            <span class='aggp'>		 5.您有權同意NEED社群平台得將會員發表於本站網域「.com.tw」及其下各次級網域內之著作以不同形式呈現及彙整於NEED社群平台網站中，以供網友查詢及閱讀。但於未經著作權人同意前，NEED社群平台無權將著作刊載於非網路形式之書報雜誌刊物。 </span>";
		out+="            <span class='aggp'>		 6.您同意瀏覽NEED社群平台網站之網友在非營利用途下，得下載或列印您所發表之圖文內容。 </span>";
		out+="            <span class='aggp'>		 7.您同意NEED社群平台之管理人員在註明著作人格權人名稱及不變更原圖文內容情況下，得以將圖文編排收錄至精華區中。 </span>";
		out+="            <span class='aggp'>		 8.您同意若您所發表之圖文或其他內容有違反本站會員條款或國家法令之情形時，NEED社群平台之管理人員得刪除之。</span>";
		...
		/*
   		out+="<span class='aggp'>a.本網站會保護每一位使用者的隱私，不管是您的申請帳號、個人資料、郵件位址、或所儲存的網站資料，除了可能涉及違法、侵權、或違反使用條款、或長達一年沒有登入進行任何系統儲存動作、或經會員本人同意以外，本網站不會任意監視、增刪、修改或關閉，或將個人資料及郵件內容交予第三者，包括贊助之廣告廠商。</span>";
   		out+="<span class='aggp'>b.本網站有部份特定服務是與其他合作廠商共同經營，如果您不願將個人資料揭露給其他合作伙伴，可以選擇不同意使用這些特定服務。為完成這些特定服務，本網站可能將您個人的資料揭露給合作伙伴，但會在提供會員資料前告知會員。</span>";
   		out+="<span class='aggp'>c.在下列的情況下，本網站有可能會查看或提供您的資料給有權機關、或主張其權利受侵害並提出適當證明之第三人：</span>";
   		out+="<span class='aggp'>c.1. 依法令規定、或依司法機關或其他有權機關的命令；</span>";
   		out+="<span class='aggp'>c.2. 為執行本使用條款、或使用者違反使用條款；</span>";
   		out+="<span class='aggp'>c.3. 為保護盛事科技股份有限公司（NEED）會員服務系統之安全或經營者之合法權益；</span>";
   		out+="<span class='aggp'>c.4. 為保護其他使用者其他第三人的合法權益；</span>";
   		out+="<span class='aggp'>c.5. 為維護盛事科技股份有限公司（NEED）會員服務系統的正常運作。</span>";
   		out+="<span class='aggp'>d.經會員註冊成功後，為增加會員服務範圍，不須另行註冊即享有本公司各項產品之會員資格，本公司將於各產品內進行會員資料的建檔、揭露、轉介、或交互運用，但本公司仍保有拒絕或暫停產品服務的權利。</span>";
   		out+="<span class='aggp'>e.NEED社群也自動接收並記錄您電腦和瀏覽器上的資料，包括 IP位址、NEED社群cookie中的資料、使用之軟體和硬體以及您瀏覽的網頁紀錄。在您使用NEED社群產品及服務期間，NEED社群將資料用作以下用途：改善NEED社群產品與服務品質、聯絡您、進行研究，以及提供內部及外部客戶不載有個人資料之市場分析或業務報告。</span>";
			*/
