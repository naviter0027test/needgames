...
#######################################
	 ...
	 function getdetail($mytable,$mypage){
		...
		echo "<h2>".$GLOBALS['mytitle']."管理</Th></TR>";
		echo "<TABLE class=formtable style='width:800px'>";	
		...
		echo "<tr><td width=800 colspan=2><textarea name='newscontent' style='width:680px;height:400px;background:#333333;'>".$list['newscontent']."</textarea></td></TR>";
